      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-24">
          <Link to="/" className="flex items-center space-x-2">
            <img src="/reelm-icon.png" alt="REELM Logo" className="h-12 sm:h-16 md:h-20 lg:h-24 py-1 w-auto object-contain cursor-pointer transform hover:scale-105 transition-transform duration-300" />
          </Link>
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            {user ? (
              ...
              <>
                <button onClick={handleLoginClick} className="text-white/80 hover:text-white font-inter text-[clamp(11px,1.5vw,14px)] transition-colors uppercase tracking-wider mr-1 sm:mr-2 whitespace-nowrap">
                  Log In
                </button>
                <Link to="/book" className="bg-marquee-red hover:bg-red-700 text-white font-bold rounded-full px-[clamp(12px,2.5vw,32px)] py-[clamp(6px,1vw,12px)] text-[clamp(11px,1.5vw,16px)] whitespace-nowrap shadow-[0_0_15px_rgba(211,47,47,0.5)] transition-colors">
                  Book Now
